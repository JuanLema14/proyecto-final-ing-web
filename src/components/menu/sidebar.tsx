...
import {
  LayoutDashboard, Utensils, ShoppingCart, Users,
  Package, Clock, FileText, Settings, LogOut
} from 'lucide-react'
        ...
        <div className="flex items-center mt-4 space-x-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <span className={cn(
              ...
              userRole === 'GERENTE_SUCURSAL' ? "bg-blue-100 text-blue-800" :
              userRole === 'MESERO' ? "bg-green-100 text-green-800" :
